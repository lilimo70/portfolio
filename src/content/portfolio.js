export const portfolio = {
  ...
  hero: {
    ...
    introduction: "ECサイトの立ち上げ・運営では、商品選定や仕入れ、販促企画からページ制作、公開後の改善まで担当しました。また、テレビ局の宣伝制作や印刷物の制作では、媒体に合わせたデザインと関係者との調整を経験しました。現在はこれまでの企画・制作経験を生かし、Webサイトの情報設計、デザイン、実装にも取り組んでいます。",
